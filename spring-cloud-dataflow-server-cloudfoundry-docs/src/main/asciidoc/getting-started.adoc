...
Where, `CF_SERVER_VERSION` and `CONFIG_CLIENT_VERSION` versions can be the latest releases of SCDF's link:https://github.com/spring-cloud/spring-cloud-dataflow-server-cloudfoundry/releases[CF-server]
