...
Note that at the time of writing, Docker resources are not supported for tasks.
====
...
Starting with version 1.2, it is possible to register and deploy Docker based apps as part of streams using
