...
TIP: All the properties mentionned above are `@ConfigurationProperties` of the
...
TIP: Of course, all other parametrization options that were available when running the server _on_ Cloud Foundry are
