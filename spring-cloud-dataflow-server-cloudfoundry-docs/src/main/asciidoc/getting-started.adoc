...
```
export SPRING_CLOUD_DATAFLOW_FEATURES_EXPERIMENTAL_TASKS_ENABLED=true
```

or, as a command line argument when starting the data flow server `--spring.cloud.dataflow.features.experimental.tasks-enabled=true`
