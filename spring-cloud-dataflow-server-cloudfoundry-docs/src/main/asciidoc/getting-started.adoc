...
[source]
----
dataflow:> http post --target https://dataflow-nonconcentrative-knar-httptest-http.cfapps.io --data "hello world"
----
...
and building it yourself. Then follow the https://docs.pivotal.io/spring-cloud-services/config-server[documentation]
