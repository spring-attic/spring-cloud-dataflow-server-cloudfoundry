...
```
cf set-env dataflow-server spring.cloud.dataflow.applicationProperties.task.spring.datasource.url '${vcap.services.mysql.credentials.jdbcUrl}'
cf set-env dataflow-server spring.cloud.dataflow.applicationProperties.task.spring.datasource.username '${vcap.services.mysql.credentials.username}'
cf set-env dataflow-server spring.cloud.dataflow.applicationProperties.task.spring.datasource.password '${vcap.services.mysql.credentials.password}'
cf set-env dataflow-server spring.cloud.dataflow.applicationProperties.task.spring.datasource.driverClassName 'org.mariadb.jdbc.Driver'
```
