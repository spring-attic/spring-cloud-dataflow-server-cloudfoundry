...
NOTE: If you are deploying in an enviornment that requires you to sign on using the Pivotal Single Sign-On Service, refer to the section <<getting-started-security-cloud-foundry>> for how to set additional configuration properties for this environment.
